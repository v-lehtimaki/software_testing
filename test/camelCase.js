...
import camelCase from '../course_code/src/camelCase.js';
...
describe('camelCase-function', function () {
    ...
    it('Should camelify strings with numbers and weird whitespaces successfully', function () {
        expect(camelCase("  2  He3llo    world2 ")).to.equal("2He3LloWorld2");
        expect(camelCase(`this      
        is a 
        tes\tt sente\nnce`)).to.equal("thisIsATesTSenteNce");
    });
